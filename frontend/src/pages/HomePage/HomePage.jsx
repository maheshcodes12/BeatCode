...
function HomePage() {
	return (
		<div className="min-h-screen w-full bg-bg">
			...
			<section className="mx-auto max-w-[1180px] px-6 py-16 lg:py-24">
				<div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-[1.05fr_1fr] lg:gap-16">
					<div>
						<div className="mb-5 inline-flex items-center gap-2 rounded-full bg-brand-soft px-3 py-1.5 font-mono text-[12.5px] font-medium text-brand">
						...
						<p className="mb-8 mt-5 max-w-[460px] text-[17px] leading-relaxed text-ink-muted">
						...
						<div className="mb-10 flex flex-wrap gap-3">
							<Link
								to="/practiceproblems"
								className="rounded-[9px] bg-brand px-6 py-3 text-[15px] font-semibold text-white transition-colors hover:bg-brand-hover"
							>
								Start solving →
							</Link>
							<Link
								to="/onlinecompiler"
								className="rounded-[9px] border border-border px-6 py-3 text-[15px] font-semibold text-ink transition-colors hover:bg-[#F1F2F3]"
							>
								Open compiler
							</Link>
						</div>
						<div className="flex gap-8">
							<div>
								<div className="font-display text-[22px] font-bold text-ink">120+</div>
								<div className="mt-0.5 text-[13px] text-ink-faint">Problems</div>
							</div>
							<div>
								<div className="font-display text-[22px] font-bold text-ink">4</div>
								<div className="mt-0.5 text-[13px] text-ink-faint">Languages</div>
							</div>
							<div>
								<div className="font-display text-[22px] font-bold text-ink">Live</div>
								<div className="mt-0.5 text-[13px] text-ink-faint">Code rooms</div>
							</div>
						</div>
					</div>
					...
					<div className="overflow-hidden rounded-2xl border border-code-border bg-code-bg shadow-[0_20px_50px_-20px_rgba(0,0,0,0.35)]">
						<div className="flex items-center gap-2 border-b border-code-border px-4 py-3">
							...
							<span className="ml-2 font-mono text-xs text-ink-faint">two_sum.py</span>
						</div>
						<div className="px-[22px] py-5 font-mono text-[13.5px] leading-[1.75] text-code-text">
							<div>
						...
						<div className="border-t border-code-border px-[22px] py-3.5">
							{testRows.map((row) => (
								<div
									key={row.label}
									className="flex animate-reveal items-center gap-2.5 py-1.5 font-mono text-[12.5px] text-ink-faint opacity-0"
			...
			<section className="mx-auto max-w-[1180px] px-6 py-16">
				<div className="mb-12 max-w-[560px]">
					<div className="mb-4 inline-flex items-center gap-2 rounded-full bg-brand-soft px-3 py-1.5 font-mono text-[12.5px] font-medium text-brand">
						<span className="h-1.5 w-1.5 rounded-full bg-brand" /> What you get
					</div>
					<h2 className="font-display text-[32px] font-bold text-ink">Three ways to write code here</h2>
				...
				<div className="grid grid-cols-1 gap-5 md:grid-cols-3">
					<div className="flex flex-col gap-4 rounded-xl border border-border bg-surface p-6">
						<span className="font-mono text-[11px] font-medium uppercase tracking-wider text-ink-faint">
							01 · Practice
						</span>
						<h3 className="font-display text-lg text-ink">Practice Problems</h3>
						<p className="text-sm leading-relaxed text-ink-muted">
							Structured problems with example cases, difficulty ratings, and instant test feedback.
						</p>
						<div className="rounded-lg border border-border bg-[#FBFBFB] p-3.5 font-mono text-[11.5px]">
					...
					<div className="flex flex-col gap-4 rounded-xl border border-border bg-surface p-6">
						...
						<h3 className="font-display text-lg text-ink">Online Compiler</h3>
						<p className="text-sm leading-relaxed text-ink-muted">
							Write and run any snippet with custom input — no problem attached, just a scratchpad.
						</p>
						<div className="rounded-lg border border-border bg-[#FBFBFB] p-3.5 font-mono text-[11.5px] text-ink-muted">
					...
					<div className="flex flex-col gap-4 rounded-xl border border-border bg-surface p-6">
						...
						<h3 className="font-display text-lg text-ink">Code Room</h3>
						<p className="text-sm leading-relaxed text-ink-muted">
			...
			<div className="border-y border-border">
				<div className="mx-auto flex max-w-[1180px] items-center justify-between px-6 py-7">
					...
					<div className="flex gap-9 font-mono text-sm font-medium text-ink-muted">
						<span>C</span>
						<span>C++</span>
						<span>Java</span>
						<span>Python</span>
