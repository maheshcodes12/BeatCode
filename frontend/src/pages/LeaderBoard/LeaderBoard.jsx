...
function LeaderBoard() {
	...
	return (
		<div className="flex min-h-screen w-full flex-col bg-bg">
			<Header />
			<div className="mx-auto w-full max-w-[720px] flex-1 p-4 lg:p-8">
				{data ? (
						...
						<table className="w-full border-collapse text-left">
							...
							<tbody>
								{data.map((entry, index) => (
									<tr
										key={entry.email}
										className="cursor-pointer border-b border-border text-sm transition-colors last:border-b-0 hover:bg-[#FBFBFB]"
			...
			{toggle && (
				<div className="fixed inset-0 z-[1000] flex items-center justify-center px-4">
					...
					<div className="relative z-[1001] w-full max-w-[360px] rounded-2xl border border-border bg-surface p-6 shadow-[0_20px_50px_-20px_rgba(0,0,0,0.35)]">
						{user ? (
							<div className="flex flex-col items-center gap-4 text-center">
								...
								<div className="w-full rounded-lg border border-border bg-[#FBFBFB] px-4 py-2.5 text-sm text-ink-muted">
